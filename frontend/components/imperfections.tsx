...
const sellers: Imperfection[] = [
  {
    ...
    details: {
      condition: "Poor",
      impact: "Negative",
      description: "The shirt shows noticeable staining in the armpit area, which affects its overall appearance and value. The stains appear to be sweat-related and may require professional cleaning to remove."
    }
  },
  {
    id: 2,
    ...
    details: {
      ...
      description: "The item is in good used condition with minor signs of wear from regular use. There may be slight fading or minimal pilling, but no significant damage or stains."
    }
  },
  {
    id: 3,
    ...
    details: {
      condition: "Excellent",
      impact: "Positive",
      description: "This is a rare vintage piece with historical significance. Despite its age, it maintains excellent condition with authentic period details and craftsmanship."
    }
  },
]
              ...
              <div className="mt-4 p-4 bg-[#1a1a2e] rounded-lg border border-purple-900/50 transition-all duration-300 ease-in-out">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-300">{seller.details.condition}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Impact:</span>
                    <span className="text-gray-300">{seller.details.impact}</span>
                  </div>
                  <p className="text-gray-300 text-sm mt-2">{seller.details.description}</p>
                </div>
              </div>
            )}
          </div>
