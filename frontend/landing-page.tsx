...
// Particle class for 3D animation
class Particle {
  x: number
  y: number
  z: number
  ...
  draw(ctx: CanvasRenderingContext2D, canvasWidth: number, canvasHeight: number) {
    ...
    const x = this.x * scale + canvasWidth / 2 - (this.x * scale) / 2
    const y = this.y * scale + canvasHeight / 2 - (this.y * scale) / 2
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#0f0225] via-[#2a0668] to-[#5b23c3] text-white overflow-hidden relative">
      ...
      <header className="container mx-auto py-6 px-4 flex items-center justify-between z-10 relative">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl tracking-tight">MarketOwl</span>
        </div>
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 400, damping: 10 }}>
            <Button 
              ...
              className="bg-gradient-to-r from-purple-500 to-purple-700 hover:from-purple-600 hover:to-purple-800 text-white text-lg px-8 py-6 rounded-md shadow-lg shadow-purple-900/30"
            >
